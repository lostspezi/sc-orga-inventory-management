        ...
        <div className="flex flex-wrap items-center gap-2">
            ...
            {links.map(({ label, href, icon }) => (
                <a
                    ...
                    className="sc-btn-outline inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-[11px]"
            ...
            <button
                type="button"
                onClick={handleCopy}
                className="cursor-pointer sc-btn-outline inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-[11px]"
                style={{ fontFamily: "var(--font-mono)" }}
            >
                {copied ? (
